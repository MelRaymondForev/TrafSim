...
public final class MouseClickManager extends Thread {
    ...
    private final EditControlPanel editPanel_ = Application.getMainControlPanel().getEditPanel();
    ...
    public synchronized void signalPressed(int x, int y) {
        try {
            ...
            onEditingTab = Application.getMainControlPanel().getSelectedTabComponent() instanceof EditControlPanel;
    ...
    public void run() {
        ...
        SimulateControlPanel simulatePanel = Application.getMainControlPanel().getSimulatePanel();
