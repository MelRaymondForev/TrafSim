...
import com.fifthgen.trafficsim.gui.controlpanels.EditControlPanel;
import com.fifthgen.trafficsim.gui.controlpanels.ReportingControlPanel;
import com.fifthgen.trafficsim.gui.controlpanels.SimulateControlPanel;
...
public final class MouseClickManager extends Thread{
	...
	/**
     * Sets the {@link com.fifthgen.trafficsim.gui.DrawingArea} this MouseClickManager is associated with.
	 * 
	...
	public synchronized void signalPressed(int x, int y){
		try{
            ...
            onEditingTab = VanetSimStart.getMainControlPanel().getSelectedTabComponent() instanceof EditControlPanel;
