...
public class ReverseLineReader {
    ...
    public ReverseLineReader(String file) throws IOException {
        this(file, 100);
    }

    public ReverseLineReader(String file, long startPosition) throws IOException {
        this(file, 100, startPosition);
    }

    public ReverseLineReader(String file, int aproxBytesPerLine) throws IOException {
        super();
    ...
    public ReverseLineReader(String file, int aproxBytesPerLine, long startPosition) throws IOException {
        super();
        realReader = new RandomAccessFile(file, "r");
        this.aproxBytesPerLine = aproxBytesPerLine;
