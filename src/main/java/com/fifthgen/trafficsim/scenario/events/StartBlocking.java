...
public final class StartBlocking extends Event{
	 ...
	 * @return the text
     *
     * @see com.fifthgen.trafficsim.scenario.events.Event#getText()
	 */
	 ...
	 * Execute the task.
     *
     * @see com.fifthgen.trafficsim.scenario.events.Event#execute()
	 */
	public void execute(){
	 ...
	 * Destroys itself.
     *
     * @see com.fifthgen.trafficsim.scenario.events.Event#destroy()
	 */
	public void destroy() {
	}
