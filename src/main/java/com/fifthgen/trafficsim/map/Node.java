...
public final class Node {
        ...
        if (crossingStreets_.length < 3)
            ...
            if (count < 2) junction_ = null;
                ...
                if (foundContinuing) {
                    ...
                    if (thirdFastestStreet != null && ((fastestStreet.isOneway() && secondFastestStreet.isOneway()) ||
                            (secondFastestStreet.isOneway() && thirdFastestStreet != null && thirdFastestStreet.isOneway()) ||
                            (fastestStreet.isOneway() && thirdFastestStreet != null && thirdFastestStreet.isOneway()))) {
                ...
                if (priorityStreets.size() > 2) {
                    ...
                    if (twoWayStreet != null && firstOnewayStreet != null && secondOnewayStreet != null) {
                        if ((firstOnewayStreet.getEndNode() == this && secondOnewayStreet.getEndNode() != this) ||
                                (firstOnewayStreet.getEndNode() != this && secondOnewayStreet.getEndNode() == this))
                            count = 3;
                    }
                }
                while (priorityStreets.size() > count)
                    priorityStreets.remove(priorityStreets.size() - 1);
    ...
    public boolean equals(Object other) {
        if (other == null) return false;
            ...
            return othernode.getX() == x_ && othernode.getY() == y_;
        }
    }
