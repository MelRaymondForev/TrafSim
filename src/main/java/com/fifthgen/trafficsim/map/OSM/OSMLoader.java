package com.fifthgen.trafficsim.map.OSM;
...
public final class OSMLoader {
    ...
    public void loadOSM(File file) {
        ...
        try {
            ...
            double latitude, longitude, minLatitude = Double.MAX_VALUE, maxLatitude = -Double.MAX_VALUE, minLongitude = Double.MAX_VALUE,
                    maxLongitude = -Double.MAX_VALUE;

            boolean maxspeedSet, onewaySet, isRoundabout, laneSet, correctionSet = false, hasTrafficSignal;
            Node lastNode, node;
            OSMNode tmpNode;
            HashMap<Integer, OSMNode> OSMNodes = new HashMap<>();
            ArrayList<OSMNode> amenityNodes = new ArrayList<>();
            ArrayDeque<Integer> wayPoints = new ArrayDeque<>();
            ...
            if (rootCrsr.getLocalName().toLowerCase().equals("osm") && (rootCrsr.getAttrValue("version").equals("0.5") ||
                    rootCrsr.getAttrValue("version").equals("0.6"))) {
