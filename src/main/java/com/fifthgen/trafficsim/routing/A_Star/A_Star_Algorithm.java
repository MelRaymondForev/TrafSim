 ...
 */
package com.fifthgen.trafficsim.routing.A_Star;
...
public final class A_Star_Algorithm implements RoutingAlgorithm{
     ...
     *
     * @see    com.fifthgen.trafficsim.routing.RoutingAlgorithm#getRouting(int, int, int, int, Street, double, int, int, Street, double, Street[], int[], int[], int, int)
	 */
